...
@app.on_message(filters.command(["addsudo","ضيف حساب"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(filters.command(["sudolist", "listsudo", "sudoers","قائمة المساعدين"]) & ~BANNED_USERS)
@language
