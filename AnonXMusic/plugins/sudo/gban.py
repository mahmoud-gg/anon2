...
@app.on_message(filters.command(["gban", "globalban","العالم المبندين"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["gbannedusers", "gbanlist","يوسرات المبندين","لستة المبندين"]) & SUDOERS)
@language
