...
@app.on_message(filters.command(["blchat", "blacklistchat","تبنيد المحادثة","بلك"]) & SUDOERS)
@language
...
@app.on_message(
    filters.command(["whitelistchat", "unblacklistchat", "unblchat","شيل باند","عشانك يا خول"]) & SUDOERS
)
@language
...
@app.on_message(filters.command(["blchats", "blacklistedchats","المبندين"]) & ~BANNED_USERS)
@language
